...
public class ArticleRequestPDFService {
    ...
    public static PDDocument getArticleRequestPDF(List<ArticleRequest> articleRequests) throws IOException {
        ...
        try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
            ...
            PDFRealisationUtil.writeText(contentStream, leftMargin, dynamicY, "IMMOBILISATION");
            dynamicY -= lineHeight;
            PDFRealisationUtil.writeText(contentStream, leftMargin, dynamicY, "Antananarivo 101, Madagascar");
            dynamicY -= lineHeight;
            PDFRealisationUtil.writeText(contentStream, leftMargin, dynamicY, "tiavina@gmail.com");
            dynamicY -= lineHeight;
            PDFRealisationUtil.writeText(contentStream, leftMargin, dynamicY, "+261 32 66 131 80");
